...
class ColorizationNet(nn.Module):
  def __init__(self, input_size=128):
    ...
    # First half: ResNet
    resnet = models.resnet18(num_classes=27) # number of classes 
...
save_images = False
best_losses = 1e10
epochs = NotImplemented # chose the number of epochs
...
# ## Uncomment for load a check point 
# ## ====================== Pretrained model:
# # Load model
# check_point = 'checkpoints/V05-model-epoch-97-losses-0.047.pth' # chose a check point
...
test_transforms = transforms.Resize((256,256),  Image.BICUBIC)
Test_imagefolder = GrayscaleImageFolder('../images/test' , test_transforms)
Test_loader = torch.utils.data.DataLoader(Test_imagefolder, batch_size=16, shuffle=False)
...
check_point = 'checkpoints/V05-model-epoch-97-losses-0.047.pth'
pretrained = torch.load(check_point, map_location=lambda storage, loc: storage)
model.load_state_dict(pretrained)
